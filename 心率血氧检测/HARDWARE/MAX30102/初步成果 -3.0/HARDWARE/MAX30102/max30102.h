...
void MAX30102_GPIO(void);//配置MAX30102GPIO
uint8_t Max30102_reset(void);//复位
void MAX30102_Config(void);//相关配置
void max30102_read_fifo(void);//读取fifo
u8 check_finger(void);//检测是否有手指靠近
#endif
