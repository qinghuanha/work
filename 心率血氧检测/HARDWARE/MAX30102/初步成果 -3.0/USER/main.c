...
宏定义
*/
#define OLED_Wait_ds18b20_EventBit (1<<1)  
#define OLED_Wait_Max30102_EventBit (1<<2)
#define OLED_Wait_MPU6050_EventBit (1<<3)
#define ds18b20_EventBit  (1<<4)
#define Max30102_EventBit  (1<<5)
#define MPU6050_EventBit  (1<<6)
...
void  startTask(void *param)//开始任务，用于创建其他任务
{
	  taskENTER_CRITICAL();
		...
		xTaskCreate(MAX30102Task,"MAX30102Task",256,NULL,1,&MAX30102TaskHandle);//创建任务1
